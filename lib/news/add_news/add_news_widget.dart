...
import 'add_news_model.dart';
export 'add_news_model.dart';

/// Add a page dedicated to add artistic news articles (title , category ,
/// content )
class AddNewsWidget extends StatefulWidget {
  const AddNewsWidget({super.key});

  static String routeName = 'AddNews';
  static String routePath = '/addNews';
...
class _AddNewsWidgetState extends State<AddNewsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewsModel());
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF249689), Color(0xFF3949AB)],
                      stops: [0.0, 1.0],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Share your artistic insights with the community',
                          style:
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              await Future.wait([
                                Future(() async {
                                  context
                                      .pushNamed(DisplayNewsWidget.routeName);
                                }),
                                Future(() async {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'News Article Added Successfuly',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
