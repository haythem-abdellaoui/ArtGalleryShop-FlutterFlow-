...
import 'add_prod_model.dart';
export 'add_prod_model.dart';

class AddProdWidget extends StatefulWidget {
  const AddProdWidget({super.key});

  static String routeName = 'addProd';
  static String routePath = '/addProd';

  @override
  State<AddProdWidget> createState() => _AddProdWidgetState();
}

class _AddProdWidgetState extends State<AddProdWidget> {
  late AddProdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProdModel());
            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 15.0, 0.0),
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Name a title for your product',
                              ...
                              children: [
                                ...
                                FlutterFlowChoiceChips(
                                  options: [
                                    ...
                                    ChipData('Abstract'),
                                    ChipData('Modern'),
                                    ChipData('Calligraphic')
                                  ],
                                  onChanged: (val) => safeSetState(() =>
                                      _model.categoryValue = val?.firstOrNull),
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(90.0, 60.0, 80.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      InkWell(
