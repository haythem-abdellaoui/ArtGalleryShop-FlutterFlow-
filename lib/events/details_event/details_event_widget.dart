...
class DetailsEventWidget extends StatefulWidget {
  ...
  static String routeName = 'DetailsEvent';
  static String routePath = '/detailsEvent';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      dateTimeFormat("MMMEd", widget.id?.time),
                                      'date',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                      ...
                      if (currentUserUid == widget.id?.organizer)
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 0.0),
                          child: Row(
              ...
              if (currentUserUid != widget.id?.organizer)
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      _model.apiResultflp = await SendEmailCall.call(
                        userEmail: currentUserEmail,
                        eventName: widget.id?.name,
                      );

                      if ((_model.apiResultflp?.succeeded ?? true)) {
