            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                        ...
                        Align(
                          ...
                          child: Hero(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                'https://images.unsplash.com/photo-1515405295579-ba7b45403062?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxwYWludHxlbnwwfHx8fDE3NDAyNDc2ODZ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                width: double.infinity,
                  ...
                  if (currentUserUid == widget.prod?.owner)
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(60.0, 40.0, 40.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
                                  ...
                                  if (currentUserUid != widget.prod?.owner)
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          _model.apiResult6rp =
                                              await SmssendCall.call(
                                            to: currentPhoneNumber,
                                          );

                                          if ((_model.apiResult6rp?.succeeded ??
                                              true)) {
