...
class _UpdateEventWidgetState extends State<UpdateEventWidget> {
  ...
  void initState() {
    ...
    _model.ageTextController ??=
        TextEditingController(text: widget.id?.price.toString());
    _model.ageFocusNode ??= FocusNode();
    _model.ageFocusNode!.addListener(() => safeSetState(() {}));
    _model.descriptionTextController ??=
        TextEditingController(text: widget.id?.description);
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                await widget.id!.reference
                                    .update(createEventsRecordData(
                                  name: _model.fullNameTextController1.text,
                                  description:
                                      _model.descriptionTextController.text,
                                  price: double.tryParse(
                                      _model.ageTextController.text),
                                  time: _model.datePicked,
                                  location: _model.fullNameTextController2.text,
