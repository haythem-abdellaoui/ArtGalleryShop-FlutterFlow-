...
export 'mystore_model.dart';

/// i want to add a add button on the left corner of the screen of this page
class MystoreWidget extends StatefulWidget {
  const MystoreWidget({super.key});

  static String routeName = 'Mystore';
  static String routePath = '/mystore';

  @override
  State<MystoreWidget> createState() => _MystoreWidgetState();
}
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        'https://images.unsplash.com/photo-1518057111178-44a106bad636?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxjb2ZmZWV8ZW58MHx8fHwxNzQwMTI3ODc3fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                                        width:
                                                            MediaQuery.sizeOf(
                                                                        context)
                                                                    .width *
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      10.0, 18.0, 0.0, 0.0),
                                              child: Text(
                                                gridViewProductRecord.category,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
